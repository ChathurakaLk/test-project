            ...
            <ul
                ...
                <li>
                    <a href="{{ route('student') }}"
                        class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">students</a>
                </li>
                <li>
                    <a href="#"
                        ...
                        <div data-popover id="popover-user-profile" role="tooltip"
                            ...
                            <div class="p-3">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <div>
                                        <a href="{{ route('log-out') }}" type="button"
                                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xs px-3 py-1.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">LogOut</a>
                                    </div>
                                </div>
                                ...
                                <p class="mb-3 text-sm font-normal">
                                    <a href="#" class="hover:underline">{{ $authUser->email }}</a>
                                </p>
                            </div>
